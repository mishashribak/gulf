...
public class RealtimeBlurView extends View {
    ...
    private float mDownsampleFactor; // default_img 4
    private int mOverlayColor; // default_img #aaffffff
    private float mBlurRadius; // default_img 10dp (0 < r <= 25)
    ...
    static {
        try {
            ...
            throw new RuntimeException("RenderScript ");
        }
    }
