...
public class ViewDragHelper {
    ...
    public static abstract class Callback {
         ...
         * unlocked. The default_img behavior is to leave edges unlocked.
         *
         ...
         * The default_img implementation does not allow horizontal motion; the extending
         ...
         * The default_img implementation does not allow vertical motion; the extending
         * class must override this method and provide the desired clamping.
         *
         *
         * @param child Child view being dragged
