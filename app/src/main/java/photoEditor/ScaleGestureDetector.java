...
class ScaleGestureDetector {
    ...
    static class SimpleOnScaleGestureListener implements ScaleGestureDetector.OnScaleGestureListener {
    ...
    ScaleGestureDetector(ScaleGestureDetector.OnScaleGestureListener listener) {
        mListener = listener;
