 ...
 */
public final class UtillClass3Audio {
...
//        return sb.toString();
    ...
    public static String openUrll(String url, String method, Bundle params) throws MalformedURLException, IOException {
        ...
        try {
            if (!method.equals("GET"))
            {
                ...
                for (String key : params.keySet())
                {
                    ...
                    {
                        dataparams.putByteArray(key, params.getByteArray(key));
                        System.out.println("byte array:" + params.getByteArray(key));
                    }
                    else
                    {
