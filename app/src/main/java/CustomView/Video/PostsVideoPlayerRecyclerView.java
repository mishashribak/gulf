...
public class PostsVideoPlayerRecyclerView extends RecyclerView {

    private static final String TAG = "PostsVideoPlayerRecyclerView";
    private  ExoPlayerData[] mPlayer;
    private List<MemoryModel> memoryModels = new ArrayList<>();
    private Context context;
    public int playPosition = -1;

    public PostsVideoPlayerRecyclerView(@NonNull Context context) {
        super(context);
        init(context);
    }

    public PostsVideoPlayerRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
