...
public class CustomYourAnswerDlg extends Dialog {
    private OnDlgItemClickListener mListener;
    public CustomYourAnswerDlg(Context paramContext, String name,SendAnswerAdapter listAdapter) {
        super(paramContext, R.style.dialog);
        setContentView(R.layout.dialog_your_answer);
        ...
        CustomTextView txtAmendSend = findViewById(R.id.txtAmendSend);
        txtAmendSend.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
