...
@SuppressLint("NewApi")
public class SelectedLineareLayout extends LinearLayout {

    private int selectedPosition = -1;

    public SelectedLineareLayout(Context context, AttributeSet attrs,
    ...
    public SelectedLineareLayout(Context context) {
        super(context);
    }
