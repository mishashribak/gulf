...
public class FamilyGroupAdapter  extends RecyclerView.Adapter<FamilyGroupAdapter.MyViewHolder> implements SectionIndexer {
    ...
    public FamilyGroupAdapter(Context context,OnItemClickListener onItemClickListener) {
