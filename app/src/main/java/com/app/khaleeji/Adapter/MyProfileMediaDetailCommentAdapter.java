...
public class MyProfileMediaDetailCommentAdapter extends RecyclerView.Adapter<MyProfileMediaDetailCommentAdapter.SearchViewHolder>{
    ...
    public MyProfileMediaDetailCommentAdapter(Context mcontext, List<GetSlctdMediaComments> mList) {
...
//        if (mList.get(position).getProfilePicture() != null && !mList.get(position).getProfilePicture().isEmpty())
//        {
//            Picasso.with(mcontext)
//                    .load(ApiClass.ImageBaseUrl + mList.get(position).getProfilePicture())
