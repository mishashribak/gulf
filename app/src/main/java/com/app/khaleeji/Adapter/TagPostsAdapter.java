...
public class TagPostsAdapter extends RecyclerView.Adapter<TagPostsAdapter.MyViewHolder> {
    ...
    public TagPostsAdapter(Activity activity, int scrollPos,
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.txtCaption.setText(memoryModel.getCaption());
