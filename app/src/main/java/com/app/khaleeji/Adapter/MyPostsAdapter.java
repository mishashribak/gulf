...
import CustomView.Video.PostsVideoPlayerRecyclerView;
...
public class MyPostsAdapter extends RecyclerView.Adapter<MyPostsAdapter.MyViewHolder> {
    ...
    private PostsVideoPlayerRecyclerView mRecyclerView;
    private float[] currentVolume;
    private int scrollPos;

    public MyPostsAdapter(FragmentActivity activity, int  scrollPos, OnItemClickListener onItemClickListener) {
        mActivity = activity;
    ...
    public void onAttachedToRecyclerView(RecyclerView recyclerView) {
        ...
        mRecyclerView = (PostsVideoPlayerRecyclerView)recyclerView;
    }
            ...
            public void onClick(View v) {
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    public boolean onMenuItemClick(MenuItem item) {
                        onItemClickListener.onItemClick(position, AppConstants.TYPE_MORE_REMOVE);
                        return true;
                    }
                });

                popup.show();
//                holder.rlMenu.setVisibility(View.VISIBLE);
            }
        });
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public CustomTextView txtLikes, txtCaption, txtMenuRemove;
        ...
        private RelativeLayout rlMenu, rlRow;
        ...
        public MyViewHolder(View view) {
            ...
            txtMenuRemove = view.findViewById(R.id.txtMenuRemove);
